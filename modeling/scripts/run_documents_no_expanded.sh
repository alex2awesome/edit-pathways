...
katie compute run \
        ...
        --train_data_file_s3 training-data/doc_training_data_short_15_not_expanded__sampled_30000.csv \
        --notes "Classification, Document Level, Not-Expanded Labels, Docs < 15,> 5, downsampled 30,000" \
...
katie compute run \
        ...
        --num_dataloader_cpus 0 \
        --train_data_file_s3 training-data/doc_training_data_short_15_not_expanded__sampled_30000.csv \
        --notes "Normal Regression, Document Level, Not-Expanded Labels, Docs < 15,> 5, downsampled 30,000" \
        --freeze_encoder_layers $frozen_layers \
        --dropout .1 \
        --accumulate_grad_batches 1 \
        --learning_rate 1e-4 \
...
katie compute run \
        ...
        --num_dataloader_cpus 0 \
        --train_data_file_s3 training-data/doc_training_data_short_15_not_expanded__sampled_30000.csv \
        --notes "Poisson Regression, Document Level, Not-Expanded Labels, Docs < 15,> 5, downsampled 30,000" \
        --freeze_encoder_layers $frozen_layers \
        --dropout .1 \
        --accumulate_grad_batches 1 \
        --learning_rate 1e-4 \
